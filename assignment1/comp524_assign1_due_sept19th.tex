...
\begin{figure}[h!]
   \includegraphics[width=10cm,height=13cm,keepaspectratio]{locations.png}
    \caption{base 64 representation of 8 bit character}
\end{figure}
...
\begin{figure}[h!]
   \includegraphics[width=10cm,height=13cm,keepaspectratio]{cipher_frequency_analysis.png}
    \caption{Cipher frequency analysis}
\end{figure}

\begin{figure}[h!]
   \includegraphics[width=18cm,height=10cm,keepaspectratio]{alpha_m.png}
    \caption{Frequency measurement value - Diagram 1}
\end{figure}

\begin{figure}[h!]
   \includegraphics[width=18cm,height=10cm,keepaspectratio]{alpha_m2.png}
    \caption{Frequency measurement value - Diagram 2}
\end{figure}
\begin{figure}[h!]
   \includegraphics[width=18cm,height=13cm,keepaspectratio]{b1_output.png}
    \caption{MAC Cipher partially decrypted base64 data}
\end{figure}
